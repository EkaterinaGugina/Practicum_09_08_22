...
if (number > 99)
{
    while (num1 > 100)     //считаем "длину" числа
    {
        ...
        num1 = (number - num1 * deg) / (deg / 10);  //делим на (deg / 10), т.к. первую цифру полученного в цикле числа (начинающегося с третьей цифры исходного числа), хотим оставить (т.к. количество цифр deg и num1 одинаковое)
